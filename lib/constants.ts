...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  Premium: {
    id: "Premium",
    price: "$10",
    features: ["5,000 monthly requests", "10 active API keys", "30-day analytics", "CSV usage export"],
    nextBilling: "Not available",
  ...
  Researcher: {
    id: "Researcher",
    price: "$50",
    features: ["Unlimited monthly requests", "No plan-level active-key cap", "30-day analytics", "CSV usage export"],
    nextBilling: "Not available",
...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      "README-grounded summaries",
      "30-day usage analytics",
      "No plan-level active-key cap",
      "Per-key request limits",
      "In-page and optional email alerts",
    ],
    cta: "Go Researcher",
    level: 2,
    dark: true,
