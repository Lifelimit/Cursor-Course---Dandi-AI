    ...
    >
      ...
      <div className="flex items-start justify-between relative z-20">
        ...
        <div className="flex flex-col items-end gap-3">
          ...
          <button 
            onClick={onDelete}
            className="rounded-full p-2 text-zinc-300 dark:text-zinc-500 transition-colors hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-500 dark:hover:text-red-400 cursor-pointer"
          >
