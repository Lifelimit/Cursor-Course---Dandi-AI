    ...
    <header className="relative mx-auto max-w-7xl px-4 pt-24 pb-8 md:px-6 md:pt-56 md:pb-40 overflow-hidden">
      <div className="grid items-center gap-8 xl:grid-cols-2 xl:gap-24">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000 ease-out max-w-2xl mx-auto xl:mx-0 text-center xl:text-left">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/5 bg-slate-950/50 px-3 py-1 text-[9px] font-bold uppercase tracking-[0.2em] text-zinc-500">
          ...
          <h1 className="font-serif text-[clamp(1.8rem,8vw,5.5rem)] font-bold leading-[1.1] tracking-tight md:text-8xl md:leading-[1.05] text-white">
            ...
            <span className="text-zinc-400 italic">Insights <span className="whitespace-nowrap">API.</span></span>
          </h1>
          
          <p className="max-w-md text-sm leading-relaxed text-zinc-400 md:text-xl mx-auto xl:mx-0">
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-center xl:justify-start max-w-xs sm:max-w-none mx-auto xl:mx-0 w-full">
            {session ? (
              <Link href="/dashboards" className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-full bg-zinc-100 px-6 py-4 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-zinc-950 shadow-2xl transition-all hover:bg-zinc-200 sm:w-auto md:px-10 md:py-5">
              ...
              <Link href="/signup" className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-full bg-zinc-100 px-6 py-4 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-zinc-950 shadow-2xl transition-all hover:bg-zinc-200 sm:w-auto md:px-10 md:py-5">
            ...
            {session && (
              <Link href="/playground" className="flex items-center justify-center gap-2 rounded-full border border-white/5 bg-zinc-955 px-6 py-4 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-zinc-550 transition-all hover:bg-white/5 hover:text-white sm:w-auto md:px-10 md:py-5 shadow-sm">
                Launch Playground
          ...
          <div className="group relative w-full max-w-[calc(100vw-2rem)] md:max-w-md overflow-hidden rounded-2xl border border-white/5 bg-zinc-950/85 p-4 md:p-6 shadow-2xl transition-all hover:border-white/10 mx-auto xl:mx-0" style={{ WebkitMaskImage: "-webkit-radial-gradient(white, black)" }}>
