...
function RepositoryMarkdownRendererComponent({ content, onShowToast }: RepositoryMarkdownRendererProps) {
...
export const RepositoryMarkdownRenderer = memo(RepositoryMarkdownRendererComponent);
