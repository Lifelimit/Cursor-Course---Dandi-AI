  ...
  return (
    <div className="space-y-3">
      ...
      <select
        ...
        disabled={disabled}
        className="h-14 w-full rounded-2xl border border-white/10 bg-slate-950/70 px-5 text-sm font-medium text-white outline-none transition focus:border-emerald-500/40 focus:ring-4 focus:ring-emerald-500/10 disabled:opacity-50"
      >
