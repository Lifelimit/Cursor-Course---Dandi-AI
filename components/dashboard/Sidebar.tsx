...
export function Sidebar({ 
  ...
  return (
    <aside className="sticky top-6 md:top-12 flex w-full h-fit flex-col gap-6 rounded-[32px] border border-zinc-200 bg-white/50 p-8 backdrop-blur-sm md:w-72 md:shrink-0">
