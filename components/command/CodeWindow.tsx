...
export function CodeWindow({
  ...
  return (
    <div className={cx("dandi-mask-radial dandi-surface-workspace dandi-intensity-subtle min-w-0 overflow-hidden rounded-[20px] font-mono text-slate-300 md:rounded-[24px]", className)}>
