        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          {session ? (
            ...
            <form
              action={async () => {
                "use server";
                await signIn("google", { redirectTo: "/dashboards" });
              }}
            >
              <button className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-zinc-900 px-8 text-white transition-colors hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200">
