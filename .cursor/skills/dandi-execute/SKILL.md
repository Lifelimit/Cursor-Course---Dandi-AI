---
name: dandi-execute
description: "Use when the user wants to implement, fix, refactor, wire up, or otherwise change Dandi code or docs. This is the delivery workflow: inspect local context, make scoped edits, run project validation, and report exactly what changed."
---
